...
\justifying
\vspace{5pt}
A similar analysis has already been carried out by CMS using 2016 data, considering only the $t \bar t$+DM signal and the dilepton final state (AN-2016-478). \vfill % \cite{PreviousDoubleTopAllLep13CMS}. \vfill
