...
\begin{titlepage}
	...
	\begin{flushright}
	\vspace*{-2.6cm}
	{\scshape\LARGE Facultad de Ciencias \\ \vspace{-12pt} Universidad de Cantabria \par}
	\end{flushright}
	\end{minipage}	
...
This search relies on the implementation of advanced analytic and Machine Learning techniques, allowing us to perform an efficient reconstruction of the $t \bar t$ system and to isolate the different signals studied with respect to the backgrounds, mainly estimated from Monte-Carlo and mostly made out of Standard Model $t \bar t$ and single top processes, and whose discriminating power was combined into a single output variable used to perform a shape analysis thanks to the definition and previous optimization of a neural network.
...
Although not formerly a part of the \ac{PF} algorithm and done off-line, the kinematic reconstruction of the $t \bar t$ system is still an extremely important part of this analysis. Indeed, many variables allowing us to discriminate the signal from the different background processes and introduced in Section~\ref{section:Variables} are spin correlated variables, sensitive to the nature of the \ac{DM} mediator but which require knowledge of the top quark and anti-quark four-momenta, not immediately available without such complete reconstruction of the $t \bar t$ system. 
...
\item At least 1 jet and 1 medium deep CSV b-jet are also required.
\end{itemize}
...
A global \textit{pre-selection region} was then defined, by applying on top of the inclusive region a few cuts:
\begin{itemize}
\item A 15 GeV Z-window veto is applied in the $ee$ and $\mu \mu$ channels;
\item The \ac{MET} should be $> 100$ GeV;
...
\subfigure[2016 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
...
A second variable, $M_{T2}(bl, bl)$, the stranverse mass of the b-jet lepton pairs can also be defined. This variable is constructed in a similar way, except that in this case, the lepton is paired with a b-jet. The b-jet/lepton permutation giving the smallest value of $M_{T2}(bl, bl)$ is kept, as shown in Figure~\ref{fig:SRdiscMT2}.
...
\item The kinematic reconstruction weight $w$ obtained from the $t \bar t$ reconstruction process is also expected to give us some discrimination to isolate our signals, for reasons already explained in Section~\ref{section:RecoTop}.
...
The distributions corresponding to these variables in the 2018 pre-selection region of the analysis can be found in Figure~\ref{fig:otherVar}.
...
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_output_scalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_output_scalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_output_scalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_output_scalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_output_scalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_output_scalar500_customBins.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_output_pseudoscalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_output_pseudoscalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_output_pseudoscalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_output_pseudoscalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_output_pseudoscalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_output_pseudoscalar500_customBins.png}
\end{minipage} \hfill
}
...
\subfigure[2016 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
...
\subfigure[2016 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
...
\hline
\multirow{1}{*}{Drell-Yan} & DYJetsToLL\_M-10to50\_TuneCUETP8M1\_13TeV-madgraphMLM-pythia8 & 15810.0 \\
...
\begin{tabular}{ c|c|c } 
 ...
 Process & Sample & Cross section [pb] \\
\hline
\multirow{1}{*}{Drell-Yan} & DYJetsToLL\_M-10to50\_TuneCP5\_13TeV-madgraphMLM-pythia8 & 15810 \\
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_2016_ttDM_scalar_100.pdf}
\end{center}
\end{minipage}\hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_2016_ttDM_scalar_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_2016_ttDM_pseudo_100.pdf}
\end{center}
\end{minipage} \hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_2016_ttDM_pseudo_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_2017_ttDM_scalar_100.pdf}
\end{center}
\end{minipage}\hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_2017_ttDM_scalar_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_2017_ttDM_pseudo_100.pdf}
\end{center}
\end{minipage} \hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_2017_ttDM_pseudo_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_2018_ttDM_scalar_100.pdf}
\end{center}
\end{minipage}\hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_2018_ttDM_scalar_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_2018_ttDM_pseudo_100.pdf}
\end{center}
\end{minipage} \hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_2018_ttDM_pseudo_500.pdf}
\end{center}
\end{minipage} \hfill
}
