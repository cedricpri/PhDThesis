...
Different control regions where the data/\ac{MC} agreement can be studied have been defined in order to check the validity of the \ac{MC} simulations performed for the \ac{SM} processes corresponding to the main backgrounds of this analysis. In this context, an inclusive control region is defined in Section~\ref{section:inclusiveCR} to spot initial issues and problems. A \ac{DY} enriched specific control region is also defined in Section~\ref{section:DYCR} while a pre-selectionr region  used for the training of the \ac{MVA} and a data validation region to ensure the quality of the \ac{MC} prediction of both the $t \bar t$ and single top processes are defined in Sections~\ref{section:PreSelCR} and~\ref{section:TopCR} respectively.% Finally, the $ttV$ and non-prompt contamination processes will be checked in Sections~\ref{section:ttVCR} and~\ref{section:SSCR} respectively.

\subsection{Inclusive control region} \label{section:inclusiveCR}

First, several distributions in a control region as inclusive as possible and mostly enriched in \ac{DY} were studied, in all the different channels available. This control region is defined as a two opposite sign tight leptons region, with a veto on any events featuring three leptons, with some small additional cuts ($m_{ll} > 20$ GeV to avoid low mass resonances, while at least 1 jet and 1 medium deep CSV b-jet are also required). The distributions obtained in all the channels in this particular control region are shown in Figure~\ref{fig:inclusiveCR}. 
...
\subsection{Pre-selection region} \label{section:PreSelCR}
...
\subfigure[2016 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
...
Several different signal regions have then actually been defined, by applying a few additional cuts on top of the pre-selection region already introduced. One signal region was defined for each \ac{MVA} training performed (more details will be given regarding this process in Section~\ref{section:Discrimination}):
\begin{itemize}
...
\subfigure[2016 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-scalar100/log_cratio_topCR_ll_BDT_both_scalar100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-scalar100/log_cratio_topCR_ll_BDT_both_scalar100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-scalar100/log_cratio_topCR_ll_BDT_both_scalar100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-scalar100/log_cratio_topCR_ll_BDT_both_scalar100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-scalar100/log_cratio_topCR_ll_BDT_both_scalar100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-scalar100/log_cratio_topCR_ll_BDT_both_scalar100_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-scalar500/log_cratio_topCR_ll_BDT_both_scalar500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-scalar500/log_cratio_topCR_ll_BDT_both_scalar500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-scalar500/log_cratio_topCR_ll_BDT_both_scalar500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-scalar500/log_cratio_topCR_ll_BDT_both_scalar500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-scalar500/log_cratio_topCR_ll_BDT_both_scalar500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-scalar500/log_cratio_topCR_ll_BDT_both_scalar500_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-pseudo100/log_cratio_topCR_ll_BDT_both_pseudoscalar100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-pseudo100/log_cratio_topCR_ll_BDT_both_pseudoscalar100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-pseudo100/log_cratio_topCR_ll_BDT_both_pseudoscalar100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-pseudo100/log_cratio_topCR_ll_BDT_both_pseudoscalar100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-pseudo100/log_cratio_topCR_ll_BDT_both_pseudoscalar100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-pseudo100/log_cratio_topCR_ll_BDT_both_pseudoscalar100_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-pseudo500/log_cratio_topCR_ll_BDT_both_pseudoscalar500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SR-tDM-pseudo500/og_cratio_topCR_ll_BDT_both_pseudoscalar500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-pseudo500/log_cratio_topCR_ll_BDT_both_pseudoscalar500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SR-tDM-pseudo500/log_cratio_topCR_ll_BDT_both_pseudoscalar500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-pseudo500/log_cratio_topCR_ll_BDT_both_pseudoscalar500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SR-tDM-pseudo500/log_cratio_topCR_ll_BDT_both_pseudoscalar500_mt2ll.png}
\end{minipage} \hfill
}
