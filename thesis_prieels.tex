...
\end{minipage} \hfill
\caption{$\Delta \Phi(\cancel{E}_{T}^{\text{miss}}, ll)$ distribution in the $t/ \bar t$+DM (on the left) and $t \bar t$+DM 2018 signal regions (on the right) for the backgrounds and several signal samples.}
\label{fig:SRdisc4}
\end{figure}
