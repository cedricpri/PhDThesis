...
\centering
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/singleTopMETNorm.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/singleTopMET.png}
\end{minipage} \hfill
...
\centering
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/placeholder.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/placeholder.png}
\end{minipage} \hfill
...
\subfigure[Dark matter mass fixed to 1 GeV]
 {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/scalarMETmChi1Norm.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/scalarMETmChi1.png}
\end{minipage} \hfill
}
\subfigure[Mediator mass fixed to 100 GeV]
 {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/scalarMETmChiLargeNorm.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/scalarMETmChiLarge.png}
\end{minipage} \hfill
}
...
\subfigure[Dark matter mass fixed to 1 GeV]
 {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/pseudoscalarMETmChi1Norm.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/pseudoscalarMETmChi1.png}
\end{minipage} \hfill
}
\subfigure[Mediator mass fixed to 100 GeV]
 {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/pseudoscalarMETmChiLargeNorm.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=8.3cm, height=6cm]{figs/pseudoscalarMETmChiLarge.png}
\end{minipage} \hfill
}
...
The idea behind this method is simple: since a 15 GeV veto in the dilepton invariant mass $m_{ll}$ is applied to both the $ee$ and $\mu \mu$ channels to reduce the \ac{DY} contamination in the signal region, then we could use use such vetoed veto events in order to estimate the \ac{DY} contribution outside of the Z-peak. Mathematically, we can start by expressing in Equation~\ref{eq:DYevents} the total number of \ac{DY} events $N_{DY}^{total}$ as the sum of events observed inside $N_{DY}^{in}$ and outside $N_{DY}^{out}$ of the Z mass window.
...
\begin{equation}
\label{eq:Routin}
N^{out}_{DY} = N^{in}_{DY, data} \cdot \left (\frac{N^{out}_{DY, MC}}{N^{in}_{DY, MC}} \right ) \equiv  N^{in}_{DY, data} \cdot R_{\text{out/in}}
\end{equation}

This previous equation obviously assumes that the Z mass window is dominated by \ac{DY}
events, which is not an evident assumption to make, since backgrounds belonging to two main categories are expected to be present in this window as well:

\begin{itemize} 
\item First, peaking backgrounds such as ZZ and WZ, which are easily taken into account since this contamination comes from a real Z boson and therefore leads to a similar $R_{\text{out/in}}$ factor. This contamination can therefore be simply subtracted inside of the Z mass window.
\item Then, non peaking backgrounds, which are expected to give a continuous distribution in the dilepton invariant mass spectrum. The estimation of the contamination due to this particular category can be done in data by measuring the number of $e \mu$ events $N^{in}_{e \mu}$ observed in the Z mass window, and by introducing the factor $k_{ll}$, equal to the constant 0.5 (to account for the combinatoric factor between both $ll$ and the single $e \mu$ final states) and multiplied by a correction due to the respective reconstruction efficiencies for both electrons and muons. The ratios $k_{ee}$ and $k_{mm}$ can be expressed easily, as shown in Equations~\ref{eq:kll}, assuming that the branching ratios to both $ee$ and $\mu \mu$ channels and the geometrical acceptances for electrons and muons are equal.

\begin{equation}
\label{eq:kll}
\begin{cases}
k_{ee} = 0.5 \cdot \sqrt{\frac{n^{obs}_{ee}}{n^{obs}_{\mu \mu}}} \\
k_{\mu \mu} = 0.5 \cdot \sqrt{\frac{n^{obs}_{\mu \mu}}{n^{obs}_{ee}}} 
\end{cases}
\end{equation}

\end{itemize}

At the end of the day, the number of estimated \ac{DY} events outside of the veto region can be obtained from Equation~\ref{eq:Rfinal}.

\begin{equation}
\label{eq:Rfinal}
N^{out}_{DY, est} = R_{\text{out/in}} \cdot \left (N^{in}_{ll, data} - k_{ll} \cdot N^{in}_{e \mu} - N^{in}_{VZ, MC} \right )
\end{equation}
...
\begin{figure}[htbp]
\centering
\subfigure[2016 $t \bar t$+W \ac{CR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/placeholder.png}
\end{minipage}\hfill
...
\subfigure[2017 $t \bar t$+W \ac{CR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/placeholder.png}
\end{minipage}\hfill
...
\subfigure[2018 $t \bar t$+W \ac{CR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/placeholder.png}
\end{minipage}\hfill
...
\begin{figure}[htbp]
\centering
\subfigure[2016 $t \bar t$+Z \ac{CR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/placeholder.png}
\end{minipage}\hfill
...
\subfigure[2017 $t \bar t$+Z \ac{CR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/placeholder.png}
\end{minipage}\hfill
...
\subfigure[2018 $t \bar t$+Z \ac{CR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/placeholder.png}
\end{minipage}\hfill
...
\hline
\textbf{Scalar mediators} & \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_50 & 3.508 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_100 & 0.790 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_150 & 0.256 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_200 & 0.107 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_250 & 0.0563 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_300 & 0.0346 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_350 & 0.0235 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_400 & 0.0144 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_450 & 0.00934 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_1\_mPhi\_500 & 0.00641 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_20\_mPhi\_100 & 0.792 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_30\_mPhi\_100 & 0.793 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_40\_mPhi\_100 & 0.803 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_45\_mPhi\_100 & 0.813 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_49\_mPhi\_100 & 0.821 \\
 TTbarDMJets\_Dilepton\_scalar\_LO\_TuneCP5\_13TeV-madgraph-mcatnlo-pythia8\_mChi\_51\_mPhi\_100 & 0.00943 \\
...
{
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=5.7cm]{figs/DNN_arch15_10_5.png}
\end{minipage}\hfill
}
\subfigure[Hidden layers 20/15/10]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=5.7cm]{figs/DNN_arch20_15_10.png}
\end{minipage} \hfill
}
\subfigure[Hidden layers 50/30/10]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=5.7cm]{figs/DNN_arch50_30_10.png}
\end{minipage}\hfill
}
...
{
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=5.7cm]{figs/DNN_arch50_30_10_5.png}
\end{minipage}\hfill
}
\subfigure[Hidden layers 50/40/30/20/10/5]
{
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=5.7cm]{figs/DNN_arch50_40_30_20_10_5.png}
\end{minipage} \hfill
}
...
{
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=5.7cm]{figs/placeholder.png}
\end{minipage}\hfill
}
\subfigure[Set 2] 
{
