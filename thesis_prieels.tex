...
\end{minipage}\hfill
\caption{pf\ac{MET} distribution in the $t/ \bar t$+DM (on the left) and $t \bar t$+DM 2018 signal regions (on the right) for the backgrounds and several signal samples.}
\label{fig:SRdiscMET}
\end{figure}
...
\begin{figure}[htbp]
\centering
\subfigure[Scalar 100 GeV signal region] {
\begin{minipage}[b]{.49\textwidth}
...
\subfigure[Pseudoscalar 100 GeV signal region] {
\begin{minipage}[b]{.49\textwidth}
