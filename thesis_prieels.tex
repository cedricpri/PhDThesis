...
Several corrections are then usually applied to the jets constructed using this algorithm, in order to take into account several parameters such as the non-linearity of the response of the calorimeter, the electronic noise, the \acf{PU} effects and the dependence of the reconstruction on the jet flavor. This typically introduces a source of uncertainty that will be taken into account and discussed in Section~\ref{section:Systematics}.
