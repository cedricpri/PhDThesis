...
After a trial and error process, the best results have been obtained with both methods for the following variables:

\color{red}FIXME: Update all these parameters and variables once final values are known! Which method did we choose? \color{black}

Training different mass points, independant on sample (cf. Nicolo)
Spanish text
...
\bibitem{NN}
\href{https://indico.cern.ch/event/5007/contributions/1177811/attachments/962648/1366777/reu_presentation3.pdf}{M. Jachowski,
