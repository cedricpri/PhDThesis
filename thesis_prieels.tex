...
\item Finally, general variables coming from different systems have also been computed since they can feature some discrimination. Among this category, we considered the invariant and transverse masses along with the $\Delta \phi$ angles of the different children in both the $t \bar t$ and $l \bar l b$ systems, as shown in Figures~\ref{fig:SRdisc7} and~\ref{fig:SRdisc8} respectively.
