...
\caption{Two different variables ($m_{ll}$, on the left, and pf\ac{MET}, on the right) represented in the $t \bar t$+Z control region defined.}
\label{fig:ttZCR}
\end{figure}
