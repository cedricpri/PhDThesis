...
\subfigure[2016 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_mt2bl.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2bl.png}
%\end{minipage} \hfill
...
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_dark_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_dark_pt.png}
\end{minipage} \hfill
}
...
\centering
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_overlapping_factor.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_overlapping_factor.png}
\end{minipage} \hfill
}
...
\centering
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_nbjet.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_nbjet.png}
\end{minipage} \hfill
...
\centering
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_reco_weight.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_reco_weight.png}
\end{minipage} \hfill
...
\item Two other interesting variables used by the \ac{ATLAS} collaboration \cite{PreviousDoubleTopDiLep13ATLAS} for their own analysis and shown in Figure~\ref{fig:r2l} are the so-called $r2l$, defined as the ratio between the pf\ac{MET} and the $p_T$ of the two leptons observed and $r2l4j$ variables, defined in a similar way but considering additionally the $p_T$ of the first 4 jets (if they exist) in the sum in the denominator.

\begin{figure}[htbp]
\centering
\subfigure[$r2l$ variable] {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_r2l.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_r2l.png}
\end{minipage} \hfill
}

\subfigure[$r2l4j$ variable] {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_r2l4j.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_r2l4j.png}
\end{minipage} \hfill
}
...
\centering
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_massT.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_massT.png}
\end{minipage} \hfill
...
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_output_scalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_output_scalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_output_scalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_output_scalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_output_scalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_output_scalar500_customBins.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_output_pseudoscalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_output_pseudoscalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_output_pseudoscalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_output_pseudoscalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_output_pseudoscalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_output_pseudoscalar500_customBins.png}
\end{minipage} \hfill
}
...
\subfigure[2016 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
...
\subfigure[2016 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
...
\subfigure[2018 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
...
\subfigure[2018 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
...
\subfigure[2018 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
...
Additionally, we checked the behaviour of the transfer factor $R_{out/in,\text{ } MC}$ across a large range of \ac{MET} values to make sure it is stable enough, as shown in Figure~\ref{fig:Rinoutcheck}. Given the relative flatness of the distributions obtained, we decided to apply a single scale factor to the \ac{DY} process, considering a systematic uncertainty simply taken as the observed maximum observed deviation between the central value and the different bins (around 30\% in this case).
...
\item An uncertainty of 20\% has been asigned to the normalization of all the minor backgrounds of the analysis (such as WW, WZ, ZZ and VVV).
