...
Several variables that will now be briefly described can be used in order to define a region enriched in the signal studied. Most of these variables will be used as the input of the \ac{MVA} technique in order to combine their discriminating power into a single variable, as will be described in Section~\ref{section:NN}.
