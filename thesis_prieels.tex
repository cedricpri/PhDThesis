...
Of course, I would especially like to thank my parents Philippe and Chantal, and my brothers Antoine and Lucas for giving me the opportunity to come and live in Spain for so long. I never could have reached this far without your presence and support that I felt daily, even more than a thousand kilometers away. Thank you to In\'{e}s as well, as I would never have started this thesis if I hadn't met you. Finally, I would like to especially thank Aline for her patience and incredible support over the past year, which helped me a lot and for which I am extremely grateful. Even though one chapter now ends, I cannot wait to get started on the next one on your side, as I am sure many great things are waiting for us in the future.
...
The distributions obtained in all the channels in this particular region are shown in Figure~\ref{fig:inclusiveCR}. A slight \ac{MC} mismodeling mostly due to the \ac{DY} process can be observed in these plots, but this feature is known in \ac{CMS} mitigated anyway with the analysis cuts applied, and compensated with the introduction of a large systematic uncertainty associated to this \ac{DY} process.
...
A global \textit{pre-selection region} was then defined as the basis for the following control and signal regions, by applying on top of the inclusive region a cut on the stransverse mass (defined in Section~\ref{section:Variables}) $M_{T2}(ll) > 80$. This allows to keep our signal regions orthogonal to the $t \bar t$ control regions used by the semi-leptonic channel, so that both channels can be combined, while removing more background than signal anyway.
...
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
...
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\caption{pf\ac{MET} distributions obtained in the 2018 pre-selection region.}
\label{fig:SRdiscMET}
\end{figure}
...
\end{minipage}\hfill
\caption{Dark $p_T$ (on th left) and overlapping factor $R$ (on the right) distributions obtained in the 2018 pre-selection region.}
\label{fig:SRdisc1}
\end{figure}
...
\item Two other interesting variables used by the \ac{ATLAS} collaboration \cite{PreviousDoubleTopDiLep13ATLAS} for their own analysis are the so-called $r2l$, defined as the ratio between the pf\ac{MET} and the $p_T$ of the two leptons observed and $r2l4j$ variables, defined in a similar way but considering additionally the $p_T$ of the first 4 jets (if they exist) in the sum in the denominator.
...
\caption{Signal versus background \ac{ROC} curves for the @c{BDT} and the \ac{ANN} obtained after the training performed, considering 100 (on the left) and 500 GeV (on the right) mediators, in the $t/\bar t$+DM training region.}
\label{fig:ROC_ST}
\end{figure}
...
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_output_scalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_output_scalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_output_scalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_output_scalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_output_scalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_output_scalar500_customBins.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_output_pseudoscalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_output_pseudoscalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_output_pseudoscalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_output_pseudoscalar500_customBins.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_output_pseudoscalar100_customBins.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_output_pseudoscalar500_customBins.png}
\end{minipage} \hfill
}
...
\subfigure[2016 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 scalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
...
\subfigure[2016 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 scalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-scalar500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pseudoscalar 100 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-pseudo100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pseudoscalar 500 GeV \ac{SR}]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/SmearSRBlinded-ttDM-pseudo500/log_cratio_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
...
Both these backgrounds are estimated directly from \ac{MC} and checked in a dedicated control region, defined from this pre-selection region, but selecting only events having a stranverse mass $60 < M_{T2}^{ll} < 80$ GeV, making this region perfectly orthogonal to our signal regions. Some of the distributions obtained in this region are shown in Figure~\ref{fig:TopCR}.
...
\end{minipage} \hfill
\caption{Leading lepton $p_T$ obtained in a 2018 same sign control region considering the data-driven production of fakes (on the left) and considering the \ac{MC} simuation (on the right).}
\label{fig:Rinoutver}
\end{center}
\end{figure}
...
\item \textbf{\acf{DY} background}. To cover for the non-flatness of the $R_{\text{in-out}}$ transfer factor and possible mismodeling of this particular background, especially at high pf\ac{MET} values, a 30\% systematic is associated to this process.
\item \textbf{Minor backgrounds}. An uncertainty of 20\% has been assigned to the normalization of all the minor backgrounds of the analysis (such as WW, WZ, ZZ and VVV).
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_Blinded2016_ttDM_scalar_100.pdf}
\end{center}
\end{minipage}\hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_Blinded2016_ttDM_scalar_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_Blinded2016_ttDM_pseudo_100.pdf}
\end{center}
\end{minipage} \hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_Blinded2016_ttDM_pseudo_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_Blinded2017_ttDM_scalar_100.pdf}
\end{center}
\end{minipage}\hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_Blinded2017_ttDM_scalar_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_Blinded2017_ttDM_pseudo_100.pdf}
\end{center}
\end{minipage} \hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_Blinded2017_ttDM_pseudo_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_Blinded2018_ttDM_scalar_100.pdf}
\end{center}
\end{minipage}\hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_Blinded2018_ttDM_scalar_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_Blinded2018_ttDM_pseudo_100.pdf}
\end{center}
\end{minipage} \hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_Blinded2018_ttDM_pseudo_500.pdf}
\end{center}
\end{minipage} \hfill
}
