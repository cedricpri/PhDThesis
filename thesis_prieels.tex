...
This background is also estimated from \ac{MC} as well and is being checked in a specific \ac{CR}.
...
\subsection{Electron selection} \label{section:EleSel}
\subsection{Muon selection} \label{section:MuSel}
