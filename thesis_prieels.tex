...
\begin{titlepage}
	...
	\textbf{Pablo Mart\'{i}nez Ru\'{i}z del \'{A}rbol}\\}
	\vspace{2.6cm}
	{\LARGE Santander, Diciembre 2021}
	\vfill
...
Upper limits on the production cross section of different signal models, both scalar and pseudoscalar, were then extracted. At the end of the day, no evidence for the existence of dark matter has been found, but upper limits on the signal strength have been obtained by considering different production models and channels. This analysis allowed us in this sense to achieve an expected (observed) exclusion for both scalar and pseudoscalar mediators up to 160 (XXX) and 145 (XXX) GeV respectively. Scalar exclusion limits were therefore improved by a factor of 2 with respect to the previous results obtained in 2016 for the $t \bar t$+DM model alone, while a pseudoscalar exclusion was achieved for the first time considering the dilepton final state only.
...
\item At least 1 jet and 1 medium deep CSV b-jet are required;
\item The \ac{MET} has to be $> 100$ GeV;
\item And the stransverse mass (defined in Section~\ref{section:Variables}) $M_{T2}(ll)$ should be $> 80$ GeV.
\end{itemize}
...
\subfigure[2016 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 pre-selection region]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
\end{minipage} \hfill
}
...
\centering
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_mblt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_nbjet.png}
\end{minipage} \hfill
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_mt2ll.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2ll.png}
%\end{minipage} \hfill
...
\end{minipage}\hfill
\begin{minipage}[b]{.47\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_mt2bl.png}
\end{minipage}\hfill
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_mt2bl.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_mt2bl.png}
%\end{minipage} \hfill
...
\centering
\begin{minipage}[b]{.47\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_dark_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.47\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_overlapping_factor.png}
\end{minipage}\hfill
...
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_dark_pt.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_dark_pt.png}
%\end{minipage} \hfill
%\begin{minipage}[b]{1.0\textwidth}
%\begin{center}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_dark_pt.png}
%\end{center}
%\end{minipage} \hfill
%}
%
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_overlapping_factor.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_overlapping_factor.png}
%\end{minipage} \hfill
%\begin{minipage}[b]{1.0\textwidth}
%\begin{center}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_overlapping_factor.png}
%\end{center}
%\end{minipage} \hfill
%}
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_mblt.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_nbjet.png}
%\end{minipage} \hfill
%\caption{$m_{bl}^t$ (on the left) and number of b-jets (on the right) distributions in the 2018 pre-selection region.}
%\label{fig:SRdiscmblt}
%\end{figure}
...
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_nbjet.png}
%\end{minipage} \hfill
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_dphillmet.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_dphillmet.png}
%\end{minipage} \hfill
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_reco_weight.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_reco_weight.png}
%\end{minipage} \hfill
...
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_r2l.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_r2l.png}
%\end{minipage} \hfill
%}
%
%\subfigure[$r2l4j$ variable] {
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_r2l4j.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_r2l4j.png}
%\end{minipage} \hfill
%}
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_massT.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_massT.png}
%\end{minipage} \hfill
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_costhetall.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_costhetall.png}
%\end{minipage} \hfill
...
%\centering
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_cosphill.png}
%\end{minipage}\hfill
%\begin{minipage}[b]{.48\textwidth}
%\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSRBlinded-ttDM-scalar100/log_cratio_topCR_ll_BDT_ttDM100_cosphill.png}
%\end{minipage} \hfill
...
\centering
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_dphillmet.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_reco_weight.png}
\end{minipage} \hfill

\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_r2l.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_r2l4j.png}
\end{minipage} \hfill

\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_massT.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_costhetall.png}
\end{minipage} \hfill
...
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_ST_BDT_output_scalar100_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_TTbar_BDT_output_scalar100_customBinsAttempt2.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_ST_BDT_output_scalar100_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_TTbar_BDT_output_scalar100_customBinsAttempt2.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_ST_BDT_output_scalar100_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_topCR_ll_TTbar_BDT_output_scalar100_customBinsAttempt2.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_topCR_ll_ST_BDT_output_scalar500_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_topCR_ll_TTbar_BDT_output_scalar500_customBinsAttempt2.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_topCR_ll_ST_BDT_output_scalar500_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_topCR_ll_TTbar_BDT_output_scalar500_customBinsAttempt2.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_topCR_ll_ST_BDT_output_scalar500_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_topCR_ll_TTbar_BDT_output_scalar500_customBinsAttempt2.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_topCR_ll_ST_BDT_output_pseudoscalar100_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_topCR_ll_TTbar_BDT_output_pseudoscalar100_customBinsAttempt2.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_topCR_ll_ST_BDT_output_pseudoscalar100_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_topCR_ll_TTbar_BDT_output_pseudoscalar100_customBinsAttempt2.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_topCR_ll_ST_BDT_output_pseudoscalar100_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_topCR_ll_TTbar_BDT_output_pseudoscalar100_customBinsAttempt2.png}
\end{minipage} \hfill
}
...
\subfigure[2016 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_topCR_ll_ST_BDT_output_pseudoscalar500_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_topCR_ll_TTbar_BDT_output_pseudoscalar500_customBinsAttempt2.png}
\end{minipage} \hfill
}

\subfigure[2017 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_topCR_ll_ST_BDT_output_pseudoscalar500_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_topCR_ll_TTbar_BDT_output_pseudoscalar500_customBinsAttempt2.png}
\end{minipage} \hfill
}

\subfigure[2018 pre-selection distributions] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_topCR_ll_ST_BDT_output_pseudoscalar500_customBinsAttempt2.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_topCR_ll_TTbar_BDT_output_pseudoscalar500_customBinsAttempt2.png}
\end{minipage} \hfill
}
...
\subfigure[2016 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_ST_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_ST_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_ST_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_ST_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_ST_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_ST_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\caption{Two different variables (pf\ac{MET}, on the left, and the stransverse mass $M_{T2}^{ll}$, on the right) represented in the $t \bar t$+DM signal region obtained from the 100 GeV scalar training.}
\label{fig:SR2}
...
\subfigure[2016 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_ST_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_ST_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_ST_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_ST_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_ST_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_ST_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-scalar500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\caption{Two different variables (pf\ac{MET}, on the left, and the stransverse mass $M_{T2}^{ll}$, on the right) represented in the $t \bar t$+DM signal region obtained from the 500 GeV scalar training.}
\label{fig:SR4}
...
\subfigure[2016 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_ST_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_ST_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_ST_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_ST_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_ST_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_ST_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo100/log_cratio_TTbar_topCR_ll_BDT_ttDM100_mt2ll.png}
\end{minipage} \hfill
}
\caption{Two different variables (pf\ac{MET}, on the left, and the stransverse mass $M_{T2}^{ll}$, on the right) represented in the $t \bar t$+DM signal region obtained from the 100 GeV pseudoscalar training.}
\label{fig:SR6}
...
\subfigure[2016 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_ST_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_ST_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_ST_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_ST_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_ST_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_ST_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
...
\subfigure[2016 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2016/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2017 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2017/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\subfigure[2018 signal region distributions]
 {
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_METcorrected_pt.png}
\end{minipage}\hfill
\begin{minipage}[b]{.48\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/2018/GroupedBkg-SmearSR-ttDM-pseudo500/log_cratio_TTbar_topCR_ll_BDT_ttDM500_mt2ll.png}
\end{minipage} \hfill
}
\caption{Two different variables (pf\ac{MET}, on the left, and the stransverse mass $M_{T2}^{ll}$, on the right) represented in the $t \bar t$+DM signal region obtained from the 500 GeV pseudoscalar training.}
\label{fig:SR8}
...
\section{$t \bar t + W$/$t \bar t + Z$} \label{subsection:ttV}
...
%
%An additional control region targeting both the $t \bar t$+W and $t \bar t$+Z processes has also been obtained, by applying a similar selection than the pre-selection of the signal regions, but by requiring at least 3 leptons instead of 2 and by asking for $M_{T2}^{ll} > 80$ GeV, mostly to remove the contamination from other backgrounds in this region. This gives us to a region enriched in both of these backgrounds but with a very limited statistics, given the large number of strong cuts applied. Results obtained in this case are shown in Figure~\ref{fig:ttVCR}.
%
%\begin{figure}[htbp]
%\centering
...
\section{Smaller backgrounds} \label{subsection:SmallerBkg}
...
\item \textbf{Minor backgrounds}. An uncertainty of 20\% has been assigned to the normalization of all the minor backgrounds of the analysis (such as the di- and tribosons production).
...
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/limit_scalar_2016.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/limit_pseudo_2016.png}
\end{minipage} \hfill
}

\subfigure[2017 exclusion limits] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/limit_scalar_2017.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/limit_pseudo_2017.png}
\end{minipage} \hfill
}

\subfigure[2018 exclusion limits] {
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/limit_scalar_2018.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/limit_pseudo_2018.png}
\end{minipage} \hfill
}
...
At the end of the day, this analysis allowed us to achieve an expected (observed) exclusion for both scalar and pseudoscalar mediators up to 165 (XXX) and 140 (XXX) GeV respectively, improving by a factor of more than 2 the previous results obtained in 2016 for the $t \bar t$+DM model alone.
...
\multirow{1}{*}{Single top} & ST\_tW\_antitop\_5f\_inclusiveDecays\_13TeV-powheg-pythia8\_TuneCUETP8M1 & 35.85 \\
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_2016_both_scalar_100.pdf}
\end{center}
\end{minipage}\hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_2016_both_scalar_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_2016_both_pseudo_100.pdf}
\end{center}
\end{minipage} \hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2016/impacts_2016_both_pseudo_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_2017_both_scalar_100.pdf}
\end{center}
\end{minipage}\hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_2017_both_scalar_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_2017_both_pseudo_100.pdf}
\end{center}
\end{minipage} \hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2017/impacts_2017_both_pseudo_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_2018_both_scalar_100.pdf}
\end{center}
\end{minipage}\hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_2018_both_scalar_500.pdf}
\end{center}
\end{minipage} \hfill
}
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_2018_both_pseudo_100.pdf}
\end{center}
\end{minipage} \hfill
}
\subfigure[500 GeV] 
...
\begin{minipage}[b]{1.0\textwidth}
\begin{center}
\includegraphics[width=12cm, height=10cm]{figs/2018/impacts_2018_both_pseudo_500.pdf}
\end{center}
\end{minipage} \hfill
}
