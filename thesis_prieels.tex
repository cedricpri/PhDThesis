...
\newpage
%
%A search for dark matter particles produced in association with one or two top quarks is presented in this work. This search is based on the implementation of advanced Machine Learning techniques, allowing us to isolate the different signals studied with respect to the backgrounds, mainly estimated from Monte-Carlo and mostly made out of Standard Model $t \bar t$ and single top processes. A neural network was in this sense introduced, giving us a new unique input variable whose shape was used and directly fed to Combine, to perform a statistical analysis and excluse possible dark matter production models, depending on the mass of the mediator. At the end of the day {PUT FINAL EXCLUSIONS OBTAINED HERE}.
...
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=6cm, height=5cm]{figs/overtraining_pseudo100.png}
\end{minipage}\hfill
\begin{minipage}[b]{.49\textwidth}
\includegraphics[width=6cm, height=5cm]{figs/overtraining_pseudo500.png}
\end{minipage}\hfill
}
