...
Additionally, we checked the behaviour of the scale factor obtained across a large range of \ac{MET} values to make sure it is stable enough, as shown in Figure~\ref{fig:Rinoutcheck}. Given the relative flatness of the scale factor, we decided to apply a single scale factor to the \ac{DY} process, associating in the mean time a systematic uncertainty simply taken as the observed maximum observed deviation between the central value and the different bins (around 30\% in this case).

\begin{figure}[htbp]
\begin{center}
\begin{minipage}[b]{.32\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/Rinout2016.png}
\end{minipage} \hfill
\begin{minipage}[b]{.32\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/Rinout2017.png}
\end{minipage} \hfill
\begin{minipage}[b]{.32\textwidth}
\includegraphics[width=7cm, height=7cm]{figs/Rinout2018.png}
\end{minipage} \hfill
...
\begin{color}{red} These plots don't have mt2ll cut applied! \begin{color}{black}
