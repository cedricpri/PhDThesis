...
\institute{PhD thesis defense \\ Instituto de F\'{i}sica de Cantabria}
...
\justifying
\vspace{5pt}
A \alert{similar analysis has already been carried out by CMS} using 2016 data, considering only the $t \bar t$+DM signal and the dilepton final state (EXO-17-014). \vfill % \cite{PreviousDoubleTopAllLep13CMS}. \vfill
