...
This talk will \textbf{be focused on the dilepton final state}, the only channel involving our group. \vfill
\end{frame}
...
\begin{itemize}
\justifying
\item Two tight leptons selected: \alert{tight POG WP} for muons, \alert{MVA WP90} for electrons;
\item Some additional minor cuts (eg., in the $d_{xy}/d_z$ impact parameters) to reduce the impact of the fakes.
\end{itemize} \vfill

\begin{block}{\centering Jets}\end{block} \vspace{-6pt}
\begin{itemize}
\justifying
\item $p_T > 30$ GeV, $|\eta| < 2.4$;
\item Tight JET/MET POG working point + loose jet PU ID (if $p_T > 50$ GeV).
\end{itemize} \vfill

\begin{block}{\centering b-tag}\end{block} \vspace{-6pt}
\begin{itemize}
\justifying
\item B-Tagging and Vertexing POG deep CSV b-tag medium WP (high efficiency, misidentification rate for a light jet as a b-jet $\sim 10\%$).
\end{itemize} \vfill

\begin{block}{\centering MET}\end{block} \vspace{-6pt}
\begin{itemize}
\justifying
\item PfType1MET considered, with xy-shift and EE noise (2017) corrections.
\end{itemize} \vfill

\begin{block}{\centering Triggers}\end{block} \vspace{-6pt}
\begin{itemize}
\justifying
\item Single and double lepton triggers combined to gain statistics, listed in the backup.
\end{itemize} \vfill
\end{frame}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			...
			\begin{block}{\centering 2016}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_inclusiveCR_ll_mll_2016.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			...
			\begin{block}{\centering 2017}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_inclusiveCR_ll_mll_2017.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			...
			\begin{block}{\centering 2018}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_inclusiveCR_ll_mll_2018.png}
    		\end{center}		
		\end{column}
\end{columns}
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_inclusiveCR_ll_METcorrected_pt_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_inclusiveCR_ll_METcorrected_pt_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_inclusiveCR_ll_METcorrected_pt_2018.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			...
			\vspace{-8pt}
			\begin{block}{\centering 2016}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_dyCR_ll_mllpeak_2016.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2017}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_dyCR_ll_mllpeak_2017.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2018}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_dyCR_ll_mllpeak_2018.png}
    		\end{center}		
		\end{column}
\end{columns}
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_dyCR_ll_METcorrected_pt_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_dyCR_ll_METcorrected_pt_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_dyCR_ll_METcorrected_pt_2018.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			...
			\vspace{-8pt}
			\begin{block}{\centering 2016}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttbarCR_ll_mll_2016.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2017}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttbarCR_ll_mll_2017.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2018}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttbarCR_ll_mll_2018.png}
    		\end{center}		
		\end{column}
\end{columns}
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttbarCR_ll_METcorrected_pt_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttbarCR_ll_METcorrected_pt_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttbarCR_ll_METcorrected_pt_2018.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}

\begin{frame}{$ttV$ control region}
\begin{columns}
\begin{column}{1.09\textwidth}
\begin{block}{\centering $ll$ channel}\end{block}
\end{column}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			...
			\vspace{-8pt}
			\begin{block}{\centering 2016}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttVCR_ll_mll_2016.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2017}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttVCR_ll_mll_2017.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2018}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttVCR_ll_mll_2018.png}
    		\end{center}		
		\end{column}
\end{columns}
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttVCR_ll_METcorrected_pt_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttVCR_ll_METcorrected_pt_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_ttVCR_ll_METcorrected_pt_2018.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			...
			\vspace{-8pt}
			\begin{block}{\centering 2016}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_SSCR_ll_mll_2016.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2017}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_SSCR_ll_mll_2017.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2018}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_SSCR_ll_mll_2018.png}
    		\end{center}		
		\end{column}
\end{columns}
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_SSCR_ll_METcorrected_pt_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_SSCR_ll_METcorrected_pt_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_SSCR_ll_METcorrected_pt_2018.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
...
At the end of the day though, the \textbf{ANN was chosen for the analysis} over the BDT, given that it gave $\sim$10\% better upper limits once optimized. \vfill

The TMVA package was then finally used to study the training performed, as shown in the next few slides for the 2016 scalar 100/500GeV training performed. \vfill	
\end{frame}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			...
			\vspace{-8pt}
			\begin{block}{\centering 2016}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_METcorrected_pt_2016.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2017}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_METcorrected_pt_2017.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2018}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_METcorrected_pt_2018.png}
    		\end{center}		
		\end{column}
\end{columns}
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_mt2ll_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_mt2ll_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_mt2ll_2018.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
...
\begin{columns}
		...
		\begin{column}{0.33\textwidth}
			\begin{center}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_dphillmet_2018.png}
    		\end{center}		
		\end{column}
\end{columns}
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_mblt_2018.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_costhetall_2018.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_nbjet_2018.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			...
			\vspace{-8pt}
			\begin{block}{\centering 2016}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar100_METcorrected_pt_2016.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2017}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar100_METcorrected_pt_2017.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar100_mt2ll_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar100_mt2ll_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar100_mt2ll_2018.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			...
			\vspace{-8pt}
			\begin{block}{\centering 2016}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar500_METcorrected_pt_2016.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
			\vspace{-8pt}
			\begin{block}{\centering 2017}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar500_METcorrected_pt_2017.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar500_mt2ll_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar500_mt2ll_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_DNN_signal0_scalar500_mt2ll_2018.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
...
\item This search is performed by defining both a DNN and a BDT, training the different networks to recognize background and signal events, to separate them and \textbf{increase the signal efficiency};
...
\begin{columns}
		...
		\begin{column}{0.33\textwidth}
			\begin{center}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_dphillmet_2016.png}
    		\end{center}		
		\end{column}
\end{columns}
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_mblt_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_costhetall_2016.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_nbjet_2016.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
...
\begin{columns}
		...
		\begin{column}{0.33\textwidth}
			\begin{center}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_dphillmet_2017.png}
    		\end{center}		
		\end{column}
\end{columns}
\begin{columns}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering Puppi MET}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_mblt_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering njet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_costhetall_2017.png}
    		\end{center}		
		\end{column}
		\begin{column}{0.33\textwidth}
			\begin{center}
				%\begin{block}{\centering nbjet}\end{block}	
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/log_cratio_topCR_ll_nbjet_2017.png}
    		\end{center}		
		\end{column}
\end{columns} \vfill
\end{frame}
