...
\item 80\%/20\% train/test splitting used ($\sim 60.000$ training events in total).
\end{itemize} \vfill
...
\includegraphics[width=4cm, height=3cm]{figs/Rinout2016_MC.png}
\end{minipage} \hfill
\begin{minipage}[b]{.32\textwidth}
\includegraphics[width=4cm, height=3cm]{figs/Rinout2017_MC.png}
\end{minipage} \hfill
\begin{minipage}[b]{.32\textwidth}
\includegraphics[width=4cm, height=3cm]{figs/Rinout2018_MC.png}
\end{minipage} \hfill
\end{center}
\end{figure} \vfill
