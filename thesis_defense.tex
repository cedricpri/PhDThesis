...
\justifying
\begin{block}{\centering Scalar mediators}\end{block}

\vspace{-10pt}
\begin{minipage}[b]{.49\textwidth}
\begin{center}
\begin{block}{\centering 100 GeV}\end{block}
\includegraphics[width=4.6cm, height=3.4cm]{figs/ROC_scalar100.png}
\end{center}
\end{minipage} \hfill
\begin{minipage}[b]{.49\textwidth}
\begin{center}
\begin{block}{\centering 500 GeV}\end{block}
\includegraphics[width=4.6cm, height=3.4cm]{figs/ROC_scalar500.png}
\end{center}
\end{minipage} \hfill
...
\begin{minipage}[b]{.49\textwidth}
\begin{center}
\includegraphics[width=4.6cm, height=3.4cm]{figs/ROC_pseudo100.png}
\end{center}
\end{minipage} \hfill
\begin{minipage}[b]{.49\textwidth}
\begin{center}
\includegraphics[width=4.6cm, height=3.4cm]{figs/ROC_pseudo500.png}
\end{center}
\end{minipage} \hfill
\end{frame}
...
\begin{center}
\begin{block}{\centering 100 GeV}\end{block}
\includegraphics[width=4.5cm, height=3.4cm]{figs/overtraining_scalar100.png}
\end{center}
\end{minipage} \hfill
\begin{minipage}[b]{.49\textwidth}
\begin{center}
\begin{block}{\centering 500 GeV}\end{block}
\includegraphics[width=4.5cm, height=3.4cm]{figs/overtraining_scalar500.png}
\end{center}
\end{minipage} \hfill
...
\begin{minipage}[b]{.49\textwidth}
\begin{center}
\includegraphics[width=4.5cm, height=3.4cm]{figs/overtraining_pseudo100.png}
\end{center}
\end{minipage} \hfill
\begin{minipage}[b]{.49\textwidth}
\begin{center}
\includegraphics[width=4.5cm, height=3.4cm]{figs/overtraining_pseudo500.png}
\end{center}
\end{minipage} \hfill
\end{frame}

%
%\begin{frame}{2018 $t/\bar t$+DM signal region}
%\begin{columns}
...
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2016/log_cratio_topCR_ll_DNN_signal1_scalar100_set8_pfmet.pdf}
%    		\end{center}		
%		\end{column} 
%		\begin{column}{0.32\textwidth}
%			\begin{center}
%			\begin{block}{\centering 2017}\end{block}
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2017/log_cratio_topCR_ll_DNN_signal1_scalar100_set8_pfmet.pdf}
%    		\end{center}		
%		\end{column} 
%		\begin{column}{0.32\textwidth}
%			\begin{center}
%			\begin{block}{\centering 2018}\end{block}
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2018/log_cratio_topCR_ll_DNN_signal1_scalar100_set8_pfmet.pdf}
%    		\end{center}		
%		\end{column}
%\end{columns} \vspace{-5pt}
%\begin{columns}
...
%			\begin{center}
%				\begin{block}{\centering njet}\end{block}	
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2017/log_cratio_topCR_ll_DNN_signal1_scalar100_set8_mt2ll.pdf}
%    		\end{center}		
%		\end{column}
%		\begin{column}{0.32\textwidth}
%			\begin{center}
%				\begin{block}{\centering nbjet}\end{block}	
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2018/log_cratio_topCR_ll_DNN_signal1_scalar100_set8_mt2ll.pdf}
%    		\end{center}		
%		\end{column}
%\end{columns} \vfill
%\end{frame}
...
%			\begin{center}
%			\begin{block}{\centering 2016}\end{block}
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2016/log_cratio_topCR_ll_DNN_signal0_scalar100_set8_pfmet.pdf}
%    		\end{center}		
%		\end{column} 
%		\begin{column}{0.32\textwidth}
%			\begin{center}
%			\begin{block}{\centering 2017}\end{block}
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2017/log_cratio_topCR_ll_DNN_signal0_scalar100_set8_pfmet.pdf}
%    		\end{center}		
%		\end{column} 
%		\begin{column}{0.32\textwidth}
%			\begin{center}
%			\begin{block}{\centering 2018}\end{block}
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2018/log_cratio_topCR_ll_DNN_signal0_scalar100_set8_pfmet.pdf}
%    		\end{center}		
%		\end{column}
%\end{columns} \vspace{-5pt}
%\begin{columns}
...
%			\begin{center}
%				\begin{block}{\centering Puppi MET}\end{block}	
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2016/log_cratio_topCR_ll_DNN_signal0_scalar100_set8_mt2ll.pdf}
%    		\end{center}		
%		\end{column}
%		\begin{column}{0.32\textwidth}
%			\begin{center}
%				\begin{block}{\centering njet}\end{block}	
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2017/log_cratio_topCR_ll_DNN_signal0_scalar100_set8_mt2ll.pdf}
%    		\end{center}		
%		\end{column}
%		\begin{column}{0.32\textwidth}
%			\begin{center}
%				%\begin{block}{\centering nbjet}\end{block}	
%     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/2018/log_cratio_topCR_ll_DNN_signal0_scalar100_set8_mt2ll.pdf}
%    		\end{center}		
%		\end{column}
%\end{columns} \vfill
%\end{frame}
