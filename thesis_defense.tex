...
\begin{itemize}
\justifying
\item Several (mostly astrophysical) evidences for the existence of dark matter, but \textbf{no direct or direct detection} so far;
...
This talk will \textbf{be focused on the dilepton final state}, in which we are mostly involved. \vfill
\end{frame}
...
\begin{block}{\centering Background normalization uncertainties}\end{block}

\begin{itemize}
\justifying
\item Single top and diboson normalization, Drell-Yan, non-prompt backgrounds.
\end{itemize} \vfill
...
\begin{columns}
		\begin{column}{0.33\textwidth}
			...
			\vspace{-8pt}
			\begin{block}{\centering 2016}\end{block}\vspace{10pt}
     			\includegraphics[width=1.0\textwidth, height=90pt]{figs/placeholder.png}
    		\end{center}		
		\end{column} 
		\begin{column}{0.33\textwidth}
			\begin{center}
