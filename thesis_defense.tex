...
\item I was the \textbf{main IFCA investigator} in charge of this particular dark matter search with top quark pairs in the dilepton final state;
\item I was also the main responsible for the \textbf{computation and application of the data-driven method} used to compute the non-prompt background for several Higgs analyses;
